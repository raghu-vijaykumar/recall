#!/usr/bin/env python3
"""
BERTopic Document Topic Modeling Prototype with Multiple Models
A comprehensive prototype for topic modeling from documents using BERTopic with multiple embedding models
"""
...
class MultiModelTopicModeler:
    ...
    def __init__(
        ...
        # Define models to test (better alternatives to all-MiniLM-L6-v2)
        self.model_configs = [
            ModelConfig(
                name="MiniLM",
            ...
            ModelConfig(
                ...
                description="Larger MiniLM model with better performance",
                min_topic_size=3,
            ),
            ModelConfig(
                name="E5_Base",
                model_name="intfloat/e5-base-v2",
                description="Modern efficient model with strong performance",
                min_topic_size=3,
            ),
        ]
...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python bertopic_document_prototype.py --file documents.txt
  python bertopic_document_prototype.py --file data.csv --output results --max-topics 15
  python bertopic_document_prototype.py --file articles.json --min-topic-size 5 --verbose
  python bertopic_document_prototype.py --file docs.txt --max-topics 0  # Automatic topic detection
  python bertopic_document_prototype.py --interactive  # Use sample data
  python bertopic_document_prototype.py --file docs.txt --visualize --summary  # With visualizations and summary
  python bertopic_document_prototype.py --file docs.txt --output results --visualize --summary
        """,
    )
